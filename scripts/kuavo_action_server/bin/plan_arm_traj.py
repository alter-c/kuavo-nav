...
def main():
    ...
    parser.add_argument("--action", type=str, default="wave", help="Action to perform")
    parser.add_argument("--mode", type=int, default=1, help="Arm control mode")
    ...
    # 加载动作文件
    file_path = rospy.get_param('~tact_file', f'./bin/action_files/{args.action}.tact')
    ...
    try:
        ...
        rospy.logerr(f"Exception during planning: {e}")
        sys.exit(2)
